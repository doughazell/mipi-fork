...
$(document).ready(function() {
              ...
              $('.tooltipcandidate').hover(function() {
                ...
                // data_element in order to make a dynamic request to
                // the server.
                var globe_id = 676176720;
                var id = 1068431259;
                tooltipRequest(globe_id, id, $(this))
/*                $(this).stop().animate({
                   opacity: 1
                 }, 200);
                    }, function() {
...
// Make an request to the server to bring back a
// tooltip window describing the object in all its
// glory.
function tooltipRequest(globe_id, data_element_id, div) {
  var req = new XMLHttpRequest();
  var url = document.location.protocol + '//' + document.location.host + '/globes/' + globe_id + '/data_elements/' + data_element_id + '/tooltip'
  req.open("GET", url)
//  alert(url);
  req.send(null);
  if (req.send == 200) {
